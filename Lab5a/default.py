...
class default(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._D4_range = Range(0, 100, 1, 40, 200)
        ...
        self.blocks_wavfile_source_1 = blocks.wavfile_source('/home/labcom/Descargas/69_punto3.wav', True)
        self.blocks_delay_0_1_1 = blocks.delay(gr.sizeof_float*1, D4)
        ...
        self.connect((self.ModulacionPAM_0_2_0, 0), (self.blocks_delay_0_1_1, 0))
        ...
        self.connect((self.blocks_delay_0_1_1, 0), (self.blocks_add_xx_0, 4))
        self.connect((self.blocks_delay_0_1_1, 0), (self.qtgui_time_sink_x_0, 4))
        self.connect((self.blocks_wavfile_source_1, 0), (self.ModulacionPAM_0_2_0, 0))
    ...
    def set_D4(self, D4):
        self.D4 = D4
        self.blocks_delay_0_1_1.set_dly(int(self.D4))
