...
class DesmultiplexaciónPAM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "DesmultiplexaciónPAM")
        ...
        self._fclow_range = Range(0, 2000, 10, 100, 200)
        self._fclow_win = RangeWidget(self._fclow_range, self.set_fclow, "'fclow'", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._fclow_win)
        self._D4_range = Range(0, 100, 1, 0, 200)
        self._D4_win = RangeWidget(self._D4_range, self.set_D4, "Retardo 4", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._D4_win)
        self._D3_range = Range(0, 100, 1, 60, 200)
        ...
        self._D2_range = Range(0, 100, 1, 40, 200)
        ...
        self._D1_range = Range(0, 100, 1, 80, 200)
        ...
        self.uhd_usrp_sink_0_0.set_center_freq(50000000, 0)
        self.uhd_usrp_sink_0_0.set_antenna("TX/RX", 0)
        self.uhd_usrp_sink_0_0.set_gain(0, 0)
        self.rational_resampler_xxx_1_1 = filter.rational_resampler_fcc(
                interpolation=1,
                decimation=1,
                taps=[],
                fractional_bw=0)
        ...
        self.connect((self.ModulacionPAM_1, 0), (self.rational_resampler_xxx_1_1, 0))
        ...
        self.connect((self.blocks_delay_1, 0), (self.ModulacionPAM_1, 0))
        self.connect((self.low_pass_filter_0, 0), (self.qtgui_time_sink_x_1, 1))
        self.connect((self.rational_resampler_xxx_1_1, 0), (self.uhd_usrp_sink_0_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(4, self.samp_rate, self.fclow, 1000, window.WIN_HAMMING, 6.76))
    ...
    def set_D4(self, D4):
        self.D4 = D4
        self.blocks_delay_1.set_dly(int(self.D4))
...
def main(top_block_cls=DesmultiplexaciónPAM, options=None):
