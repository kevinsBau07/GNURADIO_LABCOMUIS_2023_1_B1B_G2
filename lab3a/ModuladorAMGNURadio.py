...
from ModuladorSSB import ModuladorSSB  # grc-generated hier_block
...
class ModuladorAMGNURadio(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "ModuladorAMGNURadio")
        ...
        self._fdm_range = Range(1000, 300000, 1000, 200000, 200)
        self._fdm_win = RangeWidget(self._fdm_range, self.set_fdm, "Frecuencia de muestreo", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._fdm_win)
        ...
        self.ModuladorSSB_0 = ModuladorSSB(
            Ac=Ac,
            B=B,
            K=K,
        )
        self._Ka_range = Range(-4, 10, 0.01, 1, 200)
        ...
        self._Am_range = Range(0, 2, 0.01, 0.25, 200)
        ...
        # Connections
        ##################################################
        self.connect((self.ModuladorSSB_0, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.ModuladorSSB_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.ModuladorSSB_0, 0), (self.uhd_usrp_sink_0, 0))
        self.connect((self.blocks_wavfile_source_0, 0), (self.rational_resampler_xxx_0, 0))
        self.connect((self.rational_resampler_xxx_0, 0), (self.ModuladorSSB_0, 0))
    ...
    def set_K(self, K):
        self.K = K
        self.ModuladorSSB_0.set_K(self.K)
    ...
    def set_B(self, B):
        self.B = B
        self.ModuladorSSB_0.set_B(self.B)
    ...
    def set_Ac(self, Ac):
        self.Ac = Ac
        self.ModuladorSSB_0.set_Ac(self.Ac)




def main(top_block_cls=ModuladorAMGNURadio, options=None):
