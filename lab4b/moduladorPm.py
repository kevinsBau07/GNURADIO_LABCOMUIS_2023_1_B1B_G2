...
from envolCom import envolCom  # grc-generated hier_block
...
class moduladorPm(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "moduladorPm")
        ...
        self._kp_range = Range(0, 50, 0.000001, 1, 200)
        ...
        # Connections
        ##################################################
        self.connect((self.analog_sig_source_x_0, 0), (self.envolCom_0, 0))
        self.connect((self.envolCom_0, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.envolCom_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.envolCom_0, 0), (self.uhd_usrp_sink_0, 0))
    ...
    def set_kp(self, kp):
        self.kp = kp
        self.envolCom_0.set_Kp(self.kp)
    ...
    def set_Ac(self, Ac):
        self.Ac = Ac
        self.envolCom_0.set_Ac(self.Ac)




def main(top_block_cls=moduladorPm, options=None):
