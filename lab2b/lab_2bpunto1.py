...
class lab_2bpunto1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab_2bpunto1")
        ...
        self._fc_win = RangeWidget(self._fc_range, self.set_fc, "Frecuencia Portadora", "counter_slider", int, QtCore.Qt.Horizontal)
...
def main(top_block_cls=lab_2bpunto1, options=None):
